# Otto Group Product Recognition
#
# https://www.lintcode.com/ai/otto-group-product-recognition
#
# Copied from https://github.com/yuweiming70/lintcode-AI/blob/master/Otto_Group_%E5%95%86%E5%93%81%E8%AF%86%E5%88%AB.py
#
...
# 读取数据
train_data = pd.read_csv(open("./ai/OttoGroup/train.csv"))
test_data = pd.read_csv(open("./ai/OttoGroup/test.csv"))
...
print(test_y.shape)
answer = pd.read_csv(open("./ai/OttoGroup/sampleSubmission.csv"))
...
for class_name in class_list:
    ...
    j += 1
answer.to_csv("./ai/OttoGroup/submission.csv",index=False)
